...
function parseHash() {
  ...
  if (parts[0] === "properties") {
    ...
    if (parts[2] === "rooms" && parts[3])
      return { name: "room", params: { pid, rid: parts[3] } };
    return { name: "property", params: { pid, tab: parts[2] } };
  }
  if (parts[0] === "handover" && parts[1])
    return { name: "handover", params: { hid: parts[1] } };
    ...
    <header className="topbar">
      ...
      <div style={{ position: "relative" }}>
        <button
          ...
          title={t("search_placeholder", lang)}
      ...
      <div style={{ position: "relative" }}>
        ...
        {roleMenu &&
          (() => {
            const titleRaw =
              (user.titleShort && user.titleShort[lang]) ||
            ...
            const postingLabel =
              segs.slice(1).join(" · ") ||
              (user.postingId
                ? getPosting(user.postingId)?.city[lang]
                : lang === "ar"
                  ? "المقر الرئيسي · المنامة"
                  : "Headquarters · Manama");
            const divider = (
              <div
                style={{ height: 1, background: "rgba(247,248,250,0.10)" }}
              />
            );
            const eyebrow = (txt) => (
              <div
            ...
            return (
              ...
              >
                ...
                <div style={{ padding: "14px 18px 16px" }}>
                  ...
                  <div style={{ fontSize: 14, fontWeight: 500, marginTop: 7 }}>
                    {postingLabel}
                  </div>
                </div>
                {divider}
                ...
                <button
                  ...
                  onMouseEnter={(e) => {
                    e.currentTarget.style.background = "rgba(247,248,250,0.06)";
                  }}
                  onMouseLeave={(e) => {
    ...
    <nav className="breadcrumbs">
      {items.map((it, i) => (
        <React.Fragment key={i}>
          {i > 0 && (
            <Icon
              name={lang === "ar" ? "chevron_left" : "chevron_right"}
              size={11}
              className="sep"
            />
          )}
          {it.path && i < items.length - 1 ? (
            ...
            <span
              style={{
                color:
                  i === items.length - 1 ? "var(--ink)" : "var(--ink-soft)",
              }}
            >
              {it.label}
            </span>
...
function CrestMark({ size = 36 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none">
      ...
      <path
        d="M11 18 L14 22 L17 18 L20 22 L23 18 L26 22 L29 18 L32 22 L35 18 L37 22"
        stroke="#8C3A2E"
        strokeWidth="1.4"
      ...
      {/* Branches */}
      <path
        d="M14 36 Q19 33 24 35"
        stroke="#1B2845"
        strokeWidth="0.8"
        fill="none"
      />
      <path
        d="M34 36 Q29 33 24 35"
        stroke="#1B2845"
        strokeWidth="0.8"
        fill="none"
      />
