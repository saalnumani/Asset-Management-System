...
function makeBrandMaterials() {
  ...
  return {
    ...
    forestFelt:  new T.MeshStandardMaterial({ color: 0x0E3A2E, roughness: 0.7 }),
    forestDeep:  new T.MeshStandardMaterial({ color: 0x08231C, roughness: 0.65 }),
    brassMetal:  new T.MeshStandardMaterial({ color: 0xB89154, metalness: 0.85, roughness: 0.28 }),
    brassDark:   new T.MeshStandardMaterial({ color: 0x8E6E3F, metalness: 0.7, roughness: 0.4 }),
    brassSoft:   new T.MeshStandardMaterial({ color: 0xD9B888, metalness: 0.5, roughness: 0.45 }),
    ...
    velvetGreen: new T.MeshStandardMaterial({ color: 0x14503D, roughness: 0.85 }),
